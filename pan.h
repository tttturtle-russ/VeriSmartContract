...
#define PanSource	"TokenLoss.pml"
...
#define _nstates1	130	/* Contract */
#define minseq1	57
#define maxseq1	185
#define _endstate1	129

#define _nstates0	58	/* User */
#define minseq0	0
#define maxseq0	56
...
struct ALLOWANCE { /* user defined type */
	int Spender[2];
};
...
#define Air2	(sizeof(P2) - Offsetof(P2, channel) - 1*sizeof(uchar))

#define PContract	((P1 *)_this)
typedef struct P1 { /* Contract */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, p) - 1*sizeof(int))
...
typedef struct State {
	...
	#endif
#endif
	unsigned deposited_flag : 1;
	short balanceX[2];
	short balanceY[2];
	struct ALLOWANCE allowanceX[2];
	struct ALLOWANCE allowanceY[2];
#ifdef TRIX
